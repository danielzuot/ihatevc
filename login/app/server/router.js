...
// main login page //
	...
	app.post('/', function(req,res) {
		AM.findByMultipleFields([{"zip": req.body.search}, {"restname": req.body.search}], function(e, accounts){
			console.log(e)
	...
	app.post('/userlogin', function(req, res){
		AM.userManualLogin(req.param('user'), req.param('pass'), function(e, o){
			if (!o){
				res.send(e, 400);
			}	else{
			    req.session.user = o;
...
// creating new accounts //
	...
	app.get('/newuser', function(req, res) {
		res.render('newuser', {  title: 'New User', countries : CT });
	});
...
// view & delete accounts //
	...
	app.get('/allusers', function(req, res) {
		AM.getAllUsers( function(e, users){
			res.render('allusers', { title : 'Users List', usrs : users });
		})
	});

	app.get('/allratings', function(req, res) {
		AM.getAllRatings( function(e, ratings){
			res.render('allratings', { title : 'Users List', rates : ratings });
		})
	});
